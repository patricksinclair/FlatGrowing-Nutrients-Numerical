...
public class BioSystem {
    ...
    public static void exponentialGradient_spatialAndGRateDistributions(double input_alpha){
        ...
        String filename = "simple-flatGrowers-alpha="+String.valueOf(alpha)+"-spatialDistribution-FINAL";
        String filename_gRate = "simple-flatGrowers-alpha="+String.valueOf(alpha)+"-gRateDistribution-FINAL";
        String filename_precise = "simple-flatGrowers-alpha="+String.valueOf(alpha)+"-spatialDistribution_precise-FINAL";
        String filename_gRate_precise = "simple-flatGrowers-alpha="+String.valueOf(alpha)+"-gRateDistribution_precise-FINAL";
    ...
    public static void uniformGradient_spatialAndGRateDistributions(double input_c){
        ...
        String filename = "simple-flatGrowers-c="+String.valueOf(c)+"-spatialDistribution-FINAL";
        String filename_gRate = "simple-flatGrowers-c="+String.valueOf(c)+"-gRateDistribution-FINAL";
        String filename_precise = "simple-flatGrowers-c="+String.valueOf(c)+"-spatialDistribution_precise-FINAL";
        String filename_gRate_precise = "simple-flatGrowers-c="+String.valueOf(c)+"-gRateDistribution_precise-FINAL";
